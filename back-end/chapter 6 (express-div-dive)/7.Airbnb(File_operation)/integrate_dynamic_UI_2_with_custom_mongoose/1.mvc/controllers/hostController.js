...
{   
    ...
    let homeData= new Home(req.body.homeName,req.body.Location,req.body.pricePerNight,req.body.rating,req.body.photourl)
    ...
    homeData.save((error)=>{
        ...
        else
        {
            ...
            const submitPath=path.join(__dirname,"../view/submit.html")
