      ...
      // data is not comming in one pack it is comming in chunk so jase hi data ka pahla chunk aa jaye is call back ko run kar dena 
       ...
       req.on("end",()=>{
        ...
        fs.readFile(filePath,(error,data)=>{ 
                if(error){
                    res.write("it doesn't able to read: Give error")
                    console.log("it doesn't able to read: Give error")
                }
                else{
                    res.write("successfull read a data",data)
                    console.log("successfully read a data", data)
                }
            })
